...
int TTC_3(int num_v, int64_t n_edges, std::vector<int> offsets, std::vector<int> csr);
...
int main(int argc, char *argv[])
{
    ...
    data_timer.cc_stop();
    int triangles = TTC_3(graph_data.num_v, graph_data.num_edge, graph_data.offsets, graph_data.csr);
